 ...
 *                disabled. Instead, PlayerEndpoint will provide the input media
 ...
 *                pipeline which uses PlayerEndpoint to read a local file and 
 *                then streams it to a WebRTC browser such as Chrome, then the 
 *                local file must already be encoded with a VP8 or H.264 codec 
 *                profile which Chrome is able to decode. Note that for this 
 *                example, most browsers don't support ANY combination of H.264 
 *                encoding options; instead, they tend to support only a very 
...
<footer>
    Documentation generated by <a href="https://github.com/jsdoc3/jsdoc">JSDoc 3.5.5</a> on Fri Jul 13 2018 13:53:29 GMT+0000 (UTC)
</footer>
