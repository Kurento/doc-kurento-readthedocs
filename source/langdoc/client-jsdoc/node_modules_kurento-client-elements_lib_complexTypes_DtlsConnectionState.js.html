...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/kurento-client-elements/lib/complexTypes/DtlsConnectionState.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/kurento-client-elements/lib/complexTypes/DtlsConnectionState.js</h1>
 ...
 *
 * @typedef elements/complexTypes.DtlsConnectionState
 *
 * @type {(NEW|CLOSED|FAILED|CONNECTING|CONNECTED)}
 */

/**
 * Checker for {@link module:elements/complexTypes.DtlsConnectionState}
 *
 * @memberof module:elements/complexTypes
 *
 * @param {external:String} key
 * @param {module:elements/complexTypes.DtlsConnectionState} value
 */
function checkDtlsConnectionState(key, value)
{
  if(typeof value != 'string')
    throw SyntaxError(key+' param should be a String, not '+typeof value);

  if(!value.match('NEW|CLOSED|FAILED|CONNECTING|CONNECTED'))
    throw SyntaxError(key+' param is not one of [NEW|CLOSED|FAILED|CONNECTING|CONNECTED] ('+value+')');
};


module.exports = checkDtlsConnectionState;
</code></pre>
        </article>
    </section>
