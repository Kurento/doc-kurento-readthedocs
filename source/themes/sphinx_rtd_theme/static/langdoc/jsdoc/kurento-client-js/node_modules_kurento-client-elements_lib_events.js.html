...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: node_modules/kurento-client-elements/lib/events.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: node_modules/kurento-client-elements/lib/events.js</h1>
...
/**
 * Raised when the recoding effectively starts. ie: Media is received by the 
 * recorder once record method has been called.
 *
 * @event module:elements#Recording
 */

/**
 * Raised when the recorder has been stopped and all the media has been written 
 * to storage.
 *
