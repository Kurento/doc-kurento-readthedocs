...
3. Now provide this Amazon S3 URL for the template:
   ...
   .. code-block:: text
      ...
      https://s3-eu-west-1.amazonaws.com/aws.kurento.org/KMS-Coturn-cfn-7.3.0.yaml
...
.. code-block:: shell
   ...
   docker pull kurento/kurento-media-server:7.3.0
...
.. code-block:: shell
   ...
   docker run [...] kurento/kurento-media-server:7.3.0
