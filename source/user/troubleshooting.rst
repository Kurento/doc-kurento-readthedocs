...
* **Step 1**: Test with the **latest version** of Kurento Media Server: **7.1.0**. Follow the installation instructions here: :doc:`/user/installation`.
...
1. Make sure that you are running the **latest version** of Kurento Media Server: **7.1.0**.
