...
.. code-block:: shell-session
   ...
   $ docker build --tag kurento-with-video-module:7.1.0 .
   Step 1/3 : FROM kurento/kurento-media-server:7.1.0
   ...
   Successfully tagged kurento-with-video-module:7.1.0
...
.. code-block:: shell-session
   ...
   $ docker run --rm kurento-with-video-module:7.1.0 --version
   Kurento Media Server version: 7.0.0
   Found modules:
       'core' version 7.0.0
       'elements' version 7.0.0
   ...
   $ docker run --rm kurento-with-video-module:7.1.0 --list
   Available factories:
       [...]
       AppVideoModule
       appvideomodule.AppVideoModule
